...
Calculate the band structure of GaAs along high symmetry directions
Brillouin zone
"""
...
bs.plot(filename='GaAs_band.png', show=True, emax=15.0)
...
plt.savefig('GaAs_band_colored.png')
